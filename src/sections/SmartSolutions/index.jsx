...
export default function SmartSolutions() {
  return (
    <section className={s.first} id="home">
      ...
      <Image quality={100} className={s.img} src="/cel-first-2.png" width={425} height={500} alt="Dois celulares apresentando telas do whatsapp com exemplos de funcionamento dos bots de atendiment" style={{
          width: '100%',
          height: 'auto'
        }}/>
      ...
      <div className={s.ctas}>
        ...
        <Button className={s.demonstrationButton} onClick={() => window.open("https://wa.me/+5511935031331/?text=Olá!", "_blank")}>
          <Image src="/wppBlack.svg" width={29} height={29} alt="Botão de play. Um circulo preto vazado com um triângulo rotacionado a 45 graus preto" />Veja uma demonstração
        </Button>
      </div>
    </section>
  )
